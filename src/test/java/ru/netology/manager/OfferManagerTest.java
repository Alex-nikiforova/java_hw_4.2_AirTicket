...
class OfferManagerTest {
    ...
    private final Offer third = new Offer(3, 12_780, "DME", "KHV", 485);
    ...
    public void shouldFindAnyOffers() {
        Offer[] actual = manager.searchBy("Dme", "KHV", new OfferByTimeAscComparator());
        Offer[] expected = new Offer[]{second, fourth, third};
    ...
    public void shouldFindOneOffer() {
        Offer[] actual = manager.searchBy("svo", "KHV", new OfferByTimeAscComparator());
    ...
    public void shouldNotFindOffers() {
        Offer[] actual = manager.searchBy("ZIA", "KHV", new OfferByTimeAscComparator());
